...
<div class="container-fluid hero-sec srvc-hero-sec">
    <div class="container">
        <div class="left">
            <h3>Privacy</h3>
            <h1>Policy.</h1>
            <!--<h5>Unveiling Your Logo Illustration Expertise</h5>-->
            <!--<p>Elevate Your Brand with Our Premier Logo Illustration Services Breathe Life into Your Logo with Our-->
            <!--    Exceptional Illustration Services, crafting a Unique Symbol That Will Leave a Lasting Impression.-->
            <!--</p>-->
        </div>
        <div class="right">
            <div class="banner-gifboxs">
                <div class="gifbox-column">
                    <div class="bnr-srvc ">
                        <img src="assets/images/lgo-ill1.png" alt="" class="img-fluid" style="box-shadow:none;" />
                    </div>
                </div>
            </div>
        </div>
...
<section class="prvy-poly">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="prvy-box">
                    <h1>About The Policy</h1>
                    <p>At Canvas Illustrations, our first priority is the privacy of our clients and we respect it as our own. Though we collect information from our clients, it is only used to make improvements in our customer services. Our company acknowledges that the maintenance and use of our clients' information is our responsibility. We DO NOT rent or sell the information that our clients provide us online.</p>
                    ...
                    <h1>Newsletter Opt-Out</h1>
                    <p>If you no longer wish to receive our newsletter and promotional communications, you may opt-out of receiving them by following the instructions included in each newsletter or communication or by emailing us at Or calling us at <a href="tel: 866-605-0889">Toll Free: 866-605-0889</a>.</p>
                    <h1>Social Media (Features) And Widgets</h1>
                    ...
                    <p>If you have any questions about security on our Web site, you can send email us at <a href="mailto: info@canvasillustrations.com">info@canvasillustrations.com</a></p>
                    <h1>Access Of Registered Accounts</h1>
                    ...
                    <h1>Changing & Deleting/Unsubscribing Accounts</h1>
                    ...
                    <h1>Clear Gifs (Web Beacons/Web Bugs)</h1>
                    ...
                    <h1>Notification Of The Changes In Privacy Policy</h1>
                    ...
                    <h1>Questions</h1>
                    <p>We reserve the right to disclose your personally identifiable information as required by law and when we believe that disclosure is necessary to protect our rights and/or comply with a judicial proceeding, court order, or legal process served on our Web site.</p>
                    <p>If you have any questions regarding our Privacy Policy or our use of your information, call our toll free number (<a href="tel: 866-605-0889">Toll Free: 866-605-0889</a>) or email us on <a href="mailto: info@canvasillustrations.com">info@canvasillustrations.com</a></p>
                </div>
            </div>
        </div>
    </div>
